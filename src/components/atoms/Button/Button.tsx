...
const buttonClasses = {
  ...
  round:
    "text-primary bg-white rounded-full py-2 px-2 w-12 h-12 flex items-center justify-center transform transition duration-300 hover:scale-110 ",
...
export const Button: FC<IButtonProps> = ({
  ...
  <button
    className={`${buttonClasses[variant]} ${
      active && variant === "link" ? "border-b-2 border-primary" : ""
    }`}
    {...props}
  >
    {children}
